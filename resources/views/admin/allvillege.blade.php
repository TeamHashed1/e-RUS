            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Villege </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> Villege List </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                    ...
                    <div id="page-content">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Villege List</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="table-responsive no-padding">
                                  <table id="demo-foo-filtering" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                                      ...
                                      <tbody>
                                        @foreach($value as $all_villege)
                                          <tr>
                                              <td>{{$all_villege['v_name']}}</td>
                                              <td>
                                                <div class="btn-group">
                                                  ...
                                                  <ul class="dropdown-menu dropdown-menu-right">
                                                      <li><a href="/deletevillege/{{$all_villege['id']}}">Delete</a>
                                                      </li>
                                                  </ul>
                                              </div>
                                            </td>
