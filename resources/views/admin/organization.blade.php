            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Packages </h3>
                    ...
                    <div id="page-content">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Packages List</h3>
                            </div>
                                            ...
                                            <div class="col-sm-6 text-xs-center">
                                                <div class="form-group">
                                                    ...
                                                    <select id="demo-foo-filter-status" class="form-control">
                                                        ...
                                                        <option value="suspended">Organization</option>
                                                    </select>
                                                </div>
                                            </div>
                                              ...
                                              <td>
                                                <div class="btn-group">
                                                  ...
                                                  <ul class="dropdown-menu dropdown-menu-right">
                                                      <li><a href="travel_packages_details.html">Details</a>
                                                      </li>
                                                      <li><a href="edit_travel_packages.html">Edit</a>
                                                      </li>
                                                      <li><a href="/deletearea/{{$area_info['id']}}">Delete</a>
                                                      </li>
                                                  </ul>
                                              </div>
                                            </td>
