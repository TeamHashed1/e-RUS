                            ...
                            <div class="col-lg-12">
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">Add Villege</h3>
                                    </div>
                                    <!-- BASIC FORM ELEMENTS -->
                                    <!--===================================================-->
                                    <form class="panel-body form-horizontal" action="/villegeinsert" Type a message Type a message method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <!--Static-->
                                        <!--Text Input-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="v_name" id="demo-text-input" class="form-control" placeholder="Write Villege Name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <button type="submit" value="submit" class="btn btn-block btn-success">
                                                Click For Added New Villege
                                                </button>
                                            </div>
                                        </div>
