            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> District & Upazila/h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> District & Upazila list </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                    ...
                    <div id="page-content">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Word List</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="table-responsive no-padding">
                                  <table id="demo-foo-filtering" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                                      <thead>
                                          <tr>
                                              <th data-toggle="true">Word Number</th>
                                              <th>Word Name</th>
                                              <th>Action</th>
                                          </tr>
                                      </thead>
                                      <tbody>
                                        @foreach($value as $all_word)
                                          <tr>
                                              <td>{{$all_word['w_number']}}</td>
                                              <td>{{$all_word['w_name']}}</td>
                                              <td>
                                                <div class="btn-group">
                                                  ...
                                                  <ul class="dropdown-menu dropdown-menu-right">
                                                      <li><a href="/deleteword/{{$all_word['id']}}">Delete</a>
                                                      </li>
                                                  </ul>
                                              </div>
                                            </td>
