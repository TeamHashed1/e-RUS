                            ...
                            <div class="col-lg-12">
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">Add Votar</h3>
                                    </div>
                                    <!-- BASIC FORM ELEMENTS -->
                                    <!--===================================================-->
                                    <form action="/votarinsert" method="POST" enctype="multipart/form-data">
                                      @csrf
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Votar Name</label>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="v_phone" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Fater Name</label>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Number Of Brother</label>
                                                        <input name="nob" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Number Of Sister</label>
                                                        <input name="nos" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Marrital Status</label>
                                                        <select name="merri" class="form-control selectpicker">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="hof" class="form-control selectpicker">
                                                            <option>Yes</option>
                                                            <option>No</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="freedom" class="form-control selectpicker">
                                                            <option>Yes</option>
                                                            <option>No</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="address" placeholder="write here full address" rows="2" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                              <div class="col-sm-4">
                                                  <div class="form-group">
                                                      <label class="control-label">Amount Of Property Price</label>
                                                      <input name="p_price" placeholder="" type="text" class="form-control">
                                                  </div>
                                              </div>
