            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i>  Freedom Fighter </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> Freedom Fighter List </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-responsive no-padding">
                                  <table id="demo-foo-filtering" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                                      ...
                                      <tbody>
                                        @foreach($value as $all_votar)
                                          <tr>
                                              <td>{{$all_votar['v_name']}}</td>
                                              <td>{{$all_votar['v_phone']}}</td>
                                              <td>{{$all_votar['f_name']}}</td>
                                              <td>{{$all_votar['address']}}</td>
                                              <td>
                                                <div class="btn-group">
                                                  ...
                                                  <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="/rationcard/{{$all_votar['id']}}">View Card</a>
                                                    </li>
                                                      <li><a href="#">Delete</a>
                                                      </li>
                                                  </ul>
