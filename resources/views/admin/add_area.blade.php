            ...
            <div class="boxed">
                ...
                <section id="content-container">
                    <header class="pageheader">
                        <h3><i class="fa fa-home"></i> Form Travel Packages </h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel">
                                    ...
                                    <!-- BASIC FORM ELEMENTS -->
                                    <!--===================================================-->
                                    <form class="panel-body form-horizontal" action="/areainsert" Type a message Type a message method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <!--Static-->
                                        <!--Text Input-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Word Number</label>
                                            <div class="col-md-9">
                                                <input type="text" name="w_number" value="" id="demo-text-input" class="form-control" placeholder="Write Word Number">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Word Name</label>
                                            <div class="col-md-9">
                                                <input type="text" name="w_name" id="demo-text-input" class="form-control" placeholder="Write Word Name">
                                            </div>
                                        </div>
                                        <!--Email Input-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-email-input">Villege Name</label>
                                            <div class="col-md-9">
                                                <input type="text" name="v_name" id="demo-email-input" class="form-control" placeholder="enter villege name">
                                            </div>
                                        </div>
                                        <!--Password-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-password-input">Organization Type</label>
                                            <div class="col-md-9">
                                                <input type="text" name="o_name" id="demo-password-input" class="form-control" placeholder="enter Organization name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
