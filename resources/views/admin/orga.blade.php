                            ...
                            <div class="col-lg-12">
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">Add Organizations</h3>
                                    </div>
                                    <!-- BASIC FORM ELEMENTS -->
                                    <!--===================================================-->
                                    <form class="panel-body form-horizontal" action="/orgainsert" Type a message Type a message method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <!--Static-->
                                        <!--Text Input-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Organization Type</label>
                                            <div class="col-md-9">
                                                <input type="text" required name="o_type" id="demo-text-input" class="form-control" placeholder="Write Organization Type">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Organization Name</label>
                                            <div class="col-md-9">
                                                <input type="text" name="o_name" id="demo-text-input" class="form-control" placeholder="Write Organization Name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
